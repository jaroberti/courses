...
#remove the variable that we're trying to predict: logwage
...
#model the wage variable as a function of all the other variables in the dataset.  We will use the "gbm" fit; use verbose = FALSE to avoid inordinate amount of outputs
