...
library(caret)
#method = "rf" is the random forest command
...
#use the "classCenter" to see what the predictions would be at the centers of the predicted values
...
#predict new values with testing dataset
pred <- predict(modFit,testing); testing$predRight <- pred==testing$Species
#table shows specificity and sensitivity
...
#see which points were incorrectly predicted (red dots)
