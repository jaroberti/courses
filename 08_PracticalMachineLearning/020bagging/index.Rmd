...
for(i in 1:10){
  ...
  #create resampled dataset and reorder the dataset each time by the ozone variable
  ozone0 <- ozone[ss,]; ozone0 <- ozone0[order(ozone0$ozone),]
  #generate loess curve
  loess0 <- loess(temperature ~ ozone,data=ozone0,span=0.2)
  #predict the outcome for every single loess curve (ith resample etc.)
...
#each gray line represents the fit with one of the resamples datasets
for(i in 1:10){lines(1:155,ll[i,],col="grey",lwd=2)}
#average the lines together and you get the bagged loess curve (average; red line)
